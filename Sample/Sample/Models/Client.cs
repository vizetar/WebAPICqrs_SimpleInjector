...
namespace Sample.Models
{
	public class Client
	{
		...
		public void ValidateGrantTypes(IEnumerable<string> grantTypes)
		{
			...
			DisallowGrantTypeCombination(GrantType.Implicit.ToString(), GrantType.AuthCode.ToString(), grantTypes);
			DisallowGrantTypeCombination(GrantType.Implicit.ToString(), GrantType.Hybrid.ToString(), grantTypes);

			DisallowGrantTypeCombination(GrantType.AuthCode.ToString(), GrantType.Hybrid.ToString(), grantTypes);
